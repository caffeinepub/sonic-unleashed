...
import type { Character as _Character } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    constructor(private actor: ActorSubclass<_SERVICE>, private _uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, private _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, private processError?: (error: unknown) => never){}
    async addRings(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addRings(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getPlayerProgress(): Promise<PlayerProgress> {
        if (this.processError) {
            try {
                const result = await this.actor.getPlayerProgress();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async spendRings(arg0: Character): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.spendRings(to_candid_Character_n4(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "amy" in value ? Character.amy : "tails" in value ? Character.tails : "shadow" in value ? Character.shadow : "sonic" in value ? Character.sonic : "knuckles" in value ? Character.knuckles : value;
}
...
function to_candid_Character_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Character): _Character {
    return to_candid_variant_n5(_uploadFile, _downloadFile, value);
}
function to_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Character): {
    amy: null;
} | {
    tails: null;
} | {
    ...
    return value == Character.amy ? {
        amy: null
    } : value == Character.tails ? {
        tails: null
    } : value == Character.shadow ? {
        shadow: null
    } : value == Character.sonic ? {
        sonic: null
    } : value == Character.knuckles ? {
        knuckles: null
    } : value;
}
